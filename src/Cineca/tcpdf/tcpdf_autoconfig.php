...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'images/', K_PATH_MAIN.'examples/images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	//$listOflogo = array_filter(array(K_PATH_IMAGES."tcpdf_logo.jpg", K_PATH_IMAGES."CINECALOGO2008.jpg"), 'file_exists');
	//if (@file_exists(K_PATH_IMAGES.'tcpdf_logo.jpg')) {
	if (@file_exists(K_PATH_IMAGES.'CINECALOGO2008.jpg')) {
		$tcpdf_header_logo = 'CINECALOGO2008.jpg';
	}
